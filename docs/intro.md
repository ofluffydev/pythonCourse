...
7. [Functions](category/functions) - This section will cover functions in Python, including defining functions, parameters and arguments, return values, scope and global variables, and lambda functions.
    - [Defining functions](functions/defining-functions) - How to define functions in Python.
